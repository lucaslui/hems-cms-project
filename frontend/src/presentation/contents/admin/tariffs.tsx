import { Tariffs as TariffsModel } from '@/domain/entities/tariffs'
import flagTypesList from '@/domain/enums/flag-type'
...
import tariffsApi from '@/domain/api/tariffs-api'
