import devicesApi from '@/domain/api/devices-api'
import roomsApi from '@/domain/api/rooms-api'
import { Device } from '@/domain/entities/device'
import { Room } from '@/domain/entities/room'
import { getDeviceType, deviceTypeCollection, DeviceTypeKey } from '@/domain/enums/device-type'
import { getRoomType, RoomTypeKey } from '@/domain/enums/room-type'
import AccountContext from '@/presentation/contexts/account-context'
import useForm from '@/presentation/hooks/useForm'
import useValidate from '@/presentation/hooks/useValidate'
