import Percentage from '@/application/presentation/components/percentage/Percentage'
import React, { useState } from 'react'
import Styles from '@/application/presentation/styles/content/customer/customer-dashboard.scss'
import { Alert, Card, CardBody, CardHeader, CardTitle, Col, Container, Progress, Row, Table } from 'reactstrap'
import CardStats from '@/application/presentation/components/cards/CardStats'
