...
// admin imports
import AdminControllers from '@/presentation/contents/admin/controllers'
import AdminDashboard from '@/presentation/contents/admin/dashboard'
import AdminDevices from '@/presentation/contents/admin/devices'
import AdminRegions from '@/presentation/contents/admin/regions'
import AdminReports from '@/presentation/contents/admin/reports'
import AdminSystem from '@/presentation/contents/admin/system'
import AdminUsers from '@/presentation/contents/admin/users'
import AdminSetUserController from '@/presentation/contents/admin/set-user-controller'
// customer imports
import CustomerAlerts from '@/presentation/contents/customer/alerts'
import CustomerRooms from '@/presentation/contents/customer/rooms'
import CustomerDashboard from '@/presentation/contents/customer/dashboard'
import CustomerDevices from '@/presentation/contents/customer/devices'
// general imports
import GeneralEmptyFeature from '@/presentation/contents/general/empty-feature'
import { IconType } from 'react-icons'
import Icons from '@/presentation/components/icons/Icons'
import Tariffs from '@/presentation/contents/admin/tariffs'
